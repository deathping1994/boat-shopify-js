...
$(document).ready(function () {
    ...
    // if ($(".only-desktop.usp_section").length == 0 && usp_web_background_image) {
    //     $(".description.user-content.padded-row").prepend(
    //         '<div class = .only-desktop"usp_section usp_section"></div>'
    //     );
    ...
    // if ($('.mobile-only.usp_section').length == 0 && usp_mobile_background_image) {
    //     $(".description.user-content.padded-row").prepend(
    //         '<div class = .mobile-only"usp_section usp_section"></div>'
    //     );
