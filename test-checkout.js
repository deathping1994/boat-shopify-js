        ...
        if((response == "true") || (response == "True")){
            ...
            setTimeout(function(){ 
                var v = setInterval(function(){
                    if(($('.edit_checkout .fieldset:last p').length != 0) && ($('.edit_checkout .fieldset:last p').css('display')!="none") ){console.log('failed'); clearInterval(v);}
                    else if($(".notice.notice--warning .notice__content .notice__text").text().length > 0){console.log($(".notice.notice--warning .notice__content .notice__text").text());clearInterval(v);}
